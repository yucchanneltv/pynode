...
class LauncherApp:
    def __init__(self, root):
        self.root = root
        self.root.title("PN Launcher V5.5")
    ...
    def run_file(self, file_name):
        if os.path.exists(file_name) and file_name.endswith('.pn'):
            ...
            thread = threading.Thread(target=run_code, args=(code, 5_555_555_555_555_555_555_555_555_555_555_555_999_999_999_999_999_900_000_000))
